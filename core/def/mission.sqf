...
//FOB
btc_fob_mat = "B_Slingload_01_Cargo_F";//"Land_Cargo20_blue_F";
btc_fob_structure = "Land_Cargo_House_V1_F";//"Land_Cargo_HQ_V1_F";
btc_fob_flag = "Land_TripodScreen_01_dual_v1_black_F";//"Land_PowerGenerator_F;Flag_NATO_F;Land_PortableLight_single_F;OmniDirectionalAntenna_01_black_F";
btc_fob_id = 0;
btc_fob_minDistance = 1500;

//IED
//btc_type_ieds_ace = ["IEDLandBig_F", "IEDLandSmall_F"];
btc_type_ieds_ace = ["SatchelCharge_F","rhs_mine_ozm72_c","rhs_mine_tm62m","rhs_ec400","rhs_ec400_sand"];
btc_ied_deleteOn = -1;
...
switch (_p_en) do {
    case "RWR_ru_winter" : { 
        ...
        btc_type_units = ["O_RWR_soldier_aa","O_RWR_soldier_at2","O_RWR_soldier_engi","O_RWR_soldier_dm","O_RWR_soldier_tl","O_RWR_soldier_mg","O_RWR_medic","O_RWR_soldier","O_RWR_soldier_gl","O_RWR_soldier_lat","O_RWR_soldier_at","O_RWR_soldier_sl"];
        btc_type_divers = btc_type_divers;
        btc_type_crewmen = "O_RWR_crew";
        btc_type_boats = btc_type_boats;
        btc_type_motorized = ["RWR_btr80_camo","RWR_btr80a_camo","RWR_BMP3_camo","RWR_BMP3_late_camo","RWR_BMP3_3m_camo","RWR_BMP3_3mera_camo","RWR_tigr_camo","RWR_tigr_m_camo","RWR_tigr_sts_camo","RWR_ural_camo","RWR_ural_Zu23_camo"] + ["RHS_Mi8MTV3_vvs","RHS_Mi8AMT_vvs","rhs_ka60_grey"];
		btc_type_motorized_armed = ["RWR_BMP3_camo","RWR_BMP3_late_camo","RWR_BMP3_3m_camo","RWR_BMP3_3mera_camo","RWR_t90_tv_camo","RWR_t90a_tv_camo","RWR_t90am_tv_camo","RWR_t90sm_tv_camo","RWR_ural_Zu23_camo"] + ["rhs_zsu234_aa","RHS_Mi8MTV3_vvs","RHS_Mi24V_vvs","RHS_Ka52_vvs,rhs_mi28n_vvs"];
        btc_type_mg = ["rhs_Metis_9k115_2_vdv","rhs_Kornet_9M133_2_vdv","rhs_Igla_AA_pod_vdv","rhs_KORD_VDV","rhs_KORD_high_VDV","RHS_NSV_TriPod_VDV"];
        btc_type_gl = ["RHS_ZU23_VDV","rhs_SPG9M_VDV","RHS_AGS30_TriPod_VDV"];
    };
    case "OPF_G_F" : {
