...
_this addWeaponCargoGlobal ["launch_MRAWS_green_rail_F",1];
_this addWeaponCargoGlobal ["arifle_SPAR_01_blk_F",2];
_this addWeaponCargoGlobal ["arifle_SPAR_01_GL_blk_F",1];
_this addWeaponCargoGlobal ["LMG_03_F",1];
_this addWeaponCargoGlobal ["srifle_DMR_06_olive_F",1];
...
_this addItemCargoGlobal ["optic_erco_blk_f",4];
...
_this addItemCargoGlobal ["ACE_salineIV",5];
...
_this addMagazineCargoGlobal ["30Rnd_556x45_Stanag",26];
_this addMagazineCargoGlobal ["ACE_30Rnd_556x45_Stanag_Mk318_mag",10];
_this addMagazineCargoGlobal ["200Rnd_556x45_Box_F",3];
_this addMagazineCargoGlobal ["200Rnd_556x45_Box_Tracer_F",2];
_this addMagazineCargoGlobal ["20Rnd_762x51_Mag",10];
_this addMagazineCargoGlobal ["1Rnd_HE_Grenade_shell",16];
_this addMagazineCargoGlobal ["1Rnd_SmokeRed_Grenade_shell",6];
_this addMagazineCargoGlobal ["ACE_HuntIR_M203",6];
_this addMagazineCargoGlobal ["UGL_FlareWhite_F",20];
_this addMagazineCargoGlobal ["MiniGrenade",10];
_this addMagazineCargoGlobal ["SmokeShellYellow",15];
